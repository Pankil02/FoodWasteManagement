...
public class InventoryDTO {
    ...
    public InventoryDTO(String itemName, int quantity, double price, boolean isSurplus) {
    ...
    public InventoryDTO(int itemId, String itemName, int quantity, double price) {
    	this.itemId = itemId;
    	this.itemName = itemName;
        this.quantity = quantity;
        this.price = price;
